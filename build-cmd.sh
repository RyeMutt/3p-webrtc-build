...
case "$AUTOBUILD_PLATFORM" in
    darwin*)
        mkdir "x86_64"
        pushd "x86_64"
            mv "$top"/_package/webrtc.macos_x86_64.tar.bz2 webrtc.tar.bz2
            tar -xjf webrtc.tar.bz2 --strip-components=1
            rm webrtc.tar.bz2
        popd
        ...
        mkdir "arm64"
        pushd "arm64"
            mv "$top"/_package/webrtc.macos_arm64.tar.bz2 webrtc.tar.bz2
            tar -xjf webrtc.tar.bz2 --strip-components=1
            rm webrtc.tar.bz2
        popd
    ...
    ;;
    *)
        mv "$top"/_package/webrtc."$build_type".tar.bz2 webrtc.tar.bz2
        tar -xjf webrtc.tar.bz2 --strip-components=1
        rm webrtc.tar.bz2
